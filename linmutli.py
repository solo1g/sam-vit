...
class LinearMultiheadAttention(nn.Module):
    ...
    __constants__ = ['q_proj_weight', 'k_proj_weight', 'v_proj_weight',
                     'in_proj_weight', 'e_proj_weight', 'f_proj_weight']

    def __init__(self, embed_dim, num_heads=3, dropout=0.1,
                 bias=True, add_bias_kv=False, add_zero_attn=False,
                 kdim=None, vdim=None, seq_len=512, proj_k=128, param_sharing='none', num_layer=1):
    ...
    def forward(self, query, key, value, key_padding_mask=None,
                need_weights=True, attn_mask=None, num_layer=1):
        r"""
        Args:
            query, key, value: map a query and a set of key-value pairs to an output.
                See "Attention Is All You Need" for more details.
