...
class Attention(nn.Module):
    def __init__(self, num_variants, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.Wkv_odd = nn.Linear(dim, 2 * head_dim, bias=qkv_bias)
...
#     embedding_dim = 192
#     embedding_dim = ((embedding_dim, embedding_dim), (embedding_dim, embedding_dim), (embedding_dim, embedding_dim),
#                      (embedding_dim, embedding_dim))
#     heads = 3
#     num_hierarchies = 4 # number of hierarchies
#     num_layers_per_block = (2, 4, 4, 4) #the number of transformer blocks at each heirarchy, starting from the bottom
...
#     dummy_input = torch.randn(optimal_batch_size, 3, 32, 32, dtype=torch.float).cuda()
#     with torch.no_grad():
